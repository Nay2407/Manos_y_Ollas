...
public class DonacionAdaptador2 extends RecyclerView.Adapter<DonacionAdaptador2.ViewHolder> {

    private List<Donacion> donaciones;

    public DonacionAdaptador2(List<Donacion> donaciones) {
        this.donaciones = donaciones;
    }

    @NonNull
    @Override
    public DonacionAdaptador2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DonacionAdaptador2.ViewHolder holder, int position) {
